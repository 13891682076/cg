<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpStudy\PHPTutorial\WWW\cg\public/../application/index/view/index/index.html";i:1543646980;}*/ ?>
<!doctype html>
<html lang="en">
 <head>
...
<div id="nav" class="sec1200">
	<ul>
		...
		<li><a href="/index/index/gsyg_list"target="_blank">安全生产</a>
				<ul>
					 <li><a href="#">开襟卫衣</a></li>
					 <li><a href="#">套头卫衣</a></li>
				</ul>
...
<div class="ad" >
			 <ul class="slider" >
				<li><img src="/static/index/image/09.jpg"/></li>
				<li><img src="/static/index/image/12.jpg"/></li>
				<li><img src="/static/index/image/75.jpg"/></li>
			  </ul>
			  <ul class="num" >
				<li>1</li>
				<li>2</li>
...
<!-- 第二栏开始 -->
<div class="sec1200">
<div class="tab"style="width:59%;float:left">
				<div class="tab_menu">
					<ul>
						<li class="selected">产品属性</li>
						<li>产品尺码表</li>
...
<div class="tab"style="width:41%;float:right;height:240px;overflow:hidden">
				<div class="tab_menu">
					<ul>
						<li class="selected">产品属性</li>
						<li>产品尺码表</li>
				...
				<div class="tab_box">
					...
					<?php if(is_array($article) || $article instanceof \think\Collection || $article instanceof \think\Paginator): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<li style="height:20px;line-height:20px;margin-left:2px"><a href=""target="_blank"><?php echo $vo['title']; ?></a><span><?php echo date("Y-m-d",$vo['addtime']); ?><span></li>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</ul> 
					</div>
					<div class="hide">
<marquee scromallAmount=1  direction=up onmouseout="this.start()" onmouseover="this.stop()">
					来自新疆无污染的生态棉花，采用紧密纺精梳棉纱，单经双纬的织造组织，造就了颗粒饱满、朴实无华、温润细腻的经典牛津纺，易洗快干、手感丰软、吸湿性好。设计师遵循布料完美肌理，立体剪裁，以直筒明门襟的经典造型、配合圆袋、曲摆的现代人性化裁减，相得益彰，浑然天成。色彩明快的纯色衬衫简洁、自然、为您营造出利落、爽朗的形象，透出热情、优雅的个性；精选白、蓝、淡粉、宽条纹、英国格等10余种明亮、经典花型，色彩缤纷呈现，以适合本季着装，更显自然、舒适境界。
</marquee>
                    </div>
...
<div class="tab"style="width:59%;float:left">
				...
				<div class="tab_box">
				  <div class="imgtxtbox">
          <p class="imgbox"><a href="" target="_blank"><img src="/static/index/image/09.jpg" alt=""></a>
          <span><a href="" target="_blank">渭南蓝让你爱上这座城</a></span>
        </p>
        
        
        <p class="txtbox">
          <span><a href="" target="_blank">咸阳市召开巩固提升全国文明城市创建工作会议</a></span>
          <a target="_blank" href="">5月16日，咸阳市巩固提升全国文明城市创建工作会议召开。市委常委、宣传部部长马俊民总结安排工作，市委常委、副市长赵月为宣读《表彰决定》。</a>
        </p>
        
        <ul class="list">
        
          <li><span>·</span><a href="" target="_blank">西安力推“厕所革命” 城市公厕超2800座</a></li>
        
          <li><span>·</span><a href="" target="_blank">铜川新区创文办部署今年精神文明创建工作</a></li>
        
          <li><span>·</span><a href="" target="_blank">宝鸡高新区助力宝鸡发展 文明城市形象</a></li>
        
          <li><span>·</span><a href="" target="_blank">"当好东道主 做文明有礼宝鸡人"倡议书</a></li>
        
          <li><span>·</span><a href="" target="_blank">榆林佳县开展平安创建集中现场宣传活动</a></li>
        
          <li><span>·</span><a href="" target="_blank">描绘榆林新画卷 大力推进生态林业建设</a></li>
		...
		<div class="hide">
					...
					<div class="hide">
					 <p class="imgbox"><a href="" target="_blank"><img src="/static/index/image/12.jpg" alt=""></a>
          <span><a href="" target="_blank">渭南蓝让你爱上这座城</a></span>
        </p>
        ...
        <p class="txtbox">
          <span><a href="" target="_blank">咸阳市召开巩固提升全国文明城市创建工作会议</a></span>
          <a target="_blank" href=""><?php echo $article[1]['content']; ?></a>
        </p>
        
        <ul class="list">
        <?php if(is_array($article) || $article instanceof \think\Collection || $article instanceof \think\Paginator): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
          <li><span>·</span><a href="/index/index/show/?id=<?php echo $vo['id']; ?>" target="_blank"><?php echo $vo['title']; ?></a></li>
        <?php endforeach; endif; else: echo "" ;endif; ?>
...
<div class="tab"style="width:41%;height:240px;float:right;overflow:hidden">
				<div class="tab_menu">
					<ul>
						<li class="selected">产品属性</li>
						<li>产品尺码表</li>
