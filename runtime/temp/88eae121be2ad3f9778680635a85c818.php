<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"C:\phpStudy\WWW\cg\public/../application/admin/view/jsy/index.html";i:1543935595;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title></title>
...
<div class="layui-form-item" style="margin-top: 10px;">
		<div class="layui-input-inline">
			<input type="text" class="layui-input" value="<?php echo $jsy['name']; ?>" id="name" placeholder="请输入查找驾驶员姓名">
		</div>
...
limit: 16 
 ...
 form.on('switch(status)', function(obj){
            ...
            $.post('<?php echo url("jsyState"); ?>',{'id':id,'status':status},function (res) {
                layer.close(loading);
                if (res.status==1) {
                    tableIn.reload();
                }else{
...
form.on('switch(sex)', function(obj){
            ...
            $.post('<?php echo url("jsySex"); ?>',{'id':id,'sex':sex},function (res) {
                layer.close(loading);
                if (res.sex==1) {
                    tableIn.reload();
                }else{
